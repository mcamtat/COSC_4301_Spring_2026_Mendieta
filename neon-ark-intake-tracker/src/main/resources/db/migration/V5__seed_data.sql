...
VALUES
    ('FOREST', 'The Silent Forest', 8, 18, NOW()),
    ('FOREST', 'Greenglade', 10, 22, NOW()),
    ('DESERT', 'The Burning Lands', 35, 55, NOW()),
    ('DESERT', 'The Sun Disc', 30, 48, NOW()),
    ('OCEAN', 'Shadow Isles', 2, 6, NOW()),
    ('OCEAN', 'Bilgewater Bay', 18, 26, NOW()),
    ('SWAMP', 'The Serpentine Delta', 20, 32, NOW()),
    ('ARCTIC', 'Ursine Lands', -30, -10, NOW()),
    ('JUNGLE', 'Ixtal Jungle', 22, 38, NOW()),
    ('MOUNTAIN', 'Bloodcliffs', 15, 28, NOW());
